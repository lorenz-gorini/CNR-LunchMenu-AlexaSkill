...
class DailyLunchGetter:
    ...
    def find_lunch_program_in_doc_by_weekday(self, doc_file_link, weekday):
        ...
        lunch_doc = open(lunch_doc, encoding='latin_1').read()
    ...
    def lunch_handler(self, weekday):
        ...
        return gettext(self.find_lunch_program_in_doc_by_weekday(doc_file_link, weekday))
...
if __name__ == "__main__":
    l = DailyLunchGetter().lunch_handler("2019-10-28")
    print(l)